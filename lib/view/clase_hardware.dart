...
class ClaseHardware extends StatefulWidget {
  const ClaseHardware({super.key});

  @override
  State<ClaseHardware> createState() => _ClaseHardwareState();
}

class _ClaseHardwareState extends State<ClaseHardware> {
