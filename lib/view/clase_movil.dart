...
class ClaseMovil extends StatefulWidget {
  const ClaseMovil({super.key});

  @override
  State<ClaseMovil> createState() => _ClaseMovilState();
}

class _ClaseMovilState extends State<ClaseMovil> {
